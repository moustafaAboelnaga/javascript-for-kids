...
(function($, window, undefined){
  ...
  Hangman = {
    ...
    win: function(){
      ...
      this.msgTitle.html("Awesome, You guessed the prophet name!");
      // this is messy
      this.msgText.html("You guessed the prophet name in <span class='highlight'>" + rating.guesses + "</span> Guesses!<br>Score: <span class='highlight'>" + rating.rating + "%</span>");
      this.showMsg();
    ...
    lose: function(){
      this.msgTitle.html("You Lost.. The prophet was <span class='highlight'>"+ this.wrd.word +"</span>");
   ...
   /*theAnswer() initiated when you give up*/
    theAnswer: function(){
      ...
      this.msgText.html(" The prophet was <span class='highlight'>"+ this.wrd.word +"</span>");                 
	   this.showMsg();
  ...
  var wordList = ["adam", "idris", "nuh", "hud", "salih", "ibrahim", "ismail", "ishaq", "yaqub", "yusuf", "shuaib", "ayyub", "dhulkifl", "musa", "harun", "dawud", "sulayman", "ilias", "alyasa", "yunus", "zakariya", "yahya", "isa", "muhammad"];
